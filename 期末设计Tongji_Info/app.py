...
admit_info = useful_functions.admit_info()
...
@app.route('/admit')
def team_page():
    return render_template("admit.html",news=admit_info)
...
def newsResult_page():
    ...
    search_list = []
    cnn_search = pymysql.connect(host='127.0.0.1', user='root', password='67537mcl', port=3306, database='tj_news',
                                 charset='utf8')
